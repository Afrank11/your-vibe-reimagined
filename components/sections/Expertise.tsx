...
/**
 * Capabilities as a ledger, not cards: numbered rows with hairline rules.
 * All information is always visible — hover only shifts emphasis.
 */
export function Expertise() {
  return (
    <section
      id="expertise"
      className="mx-auto max-w-site scroll-mt-24 px-6 py-28 md:px-10 md:py-40"
    >
      <SectionHeading
        index="03"
        label="Expertise"
      ...
      <div className="mt-14 md:mt-20">
        {expertise.map((item, i) => (
          <Reveal key={item.index} delay={Math.min(i * 0.04, 0.2)}>
