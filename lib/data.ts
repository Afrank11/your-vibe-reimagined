 ...
 * French translations live in lib/i18n/content.fr.ts and are merged in
 * lib/i18n/content.ts — this file stays the English source of truth.
 */
...
export const contact = {
  ...
  /**
   * Both editions live in public/. Drop the French PDF in at the `fr` path
   * below and the CV picker offers it automatically — until then the picker
   * shows it as coming shortly rather than linking to a 404.
   */
  cv: {
    en: "/Ateh_Frank_Ateh_CV.pdf",
    fr: "/Ateh_Frank_Ateh_CV_FR.pdf",
  },
